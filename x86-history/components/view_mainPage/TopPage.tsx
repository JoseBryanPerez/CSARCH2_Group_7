...
export default function HugeCircle({target}:{target?:string}){
    ...
    return(
        <div className="min-h-screen min-w-screen bg-center bg-cover bg-no-repeat flex items-center justify-center"style={{backgroundImage:"url('/images/others/Bg_first.jpg')"}}>
            <div className="min-h-screen min-w-screen absolute inset-0 bg-black/75"></div>
